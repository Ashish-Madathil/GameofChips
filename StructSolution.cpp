...
{  
  ...
  do
  {
   ...
   cout << Players[0].name << " had " << Players[0].wins << " total wins this round " << endl;
   cout << Players[1].name << " had " << Players[1].wins << " total wins this round " << endl;
   outFile.close(); 
  return 0; 
} 
////////////////////////////////////////////////////////////////////////////////////
...
cout << "Player 1, please enter your name: ";
  ...
  Players[0].wins = 0;
  Players[1].wins = 0;  //initialize their number of wins to 0
}
////////////////////////////////////////////////////////////////
